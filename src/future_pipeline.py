...
class Pipeline():
    ...
    def __get_next_frame(self, current_iteration_item):
        ...
        current_iteration_item.color_frame = frame
        current_iteration_item.depth_frame = frame
        current_iteration_item.segmented_frame = frame
    ...
    def __generate_output(self, current_iteration_item):
        ...
        for (top, right, bottom, left), face_expression in itertools.zip_longest(self.face_locations,
                                                                                 self.face_expressions, fillvalue=''):
    ...
    def __next_frame_loop(self):
        ...
        while True:
            ...
            current_iteration_item = CurrentIterationItem(start_time_current, start_time_old, time_at_start,
                                                          process_next_frame, frame_number)
